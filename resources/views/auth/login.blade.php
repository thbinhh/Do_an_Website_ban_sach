...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Login'<!DOCTYPE html>
<html lang="en">
...
<body>
    ...
    <div class="container">
        <section class="Login register-layout d-flex justify-content-center my-5 form-group">
                <div class="registration border1 border2">
                    <div class="header-form">
                        <h2>Đăng nhập</h2>
                    </div>
                    <form action="{{URL::to('/login')}}" method="post" class="sub-login" autocomplete="off">
                        {{ csrf_field() }}
                        ...
                        <div class="sign-up">
                            <div>
                                ...
                                <a href="/signup" class="info-login border2 home subsignup">Đăng ký</a>
